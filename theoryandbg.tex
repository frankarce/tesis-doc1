...
\section{Learning environment}
	...
	Learning environment refers to the diverse physical locations, contexts, and cultures in which students learn. Since students may learn in a wide variety of settings, such as outside-of-school locations and outdoor environments, the term is often used as a more accurate or preferred alternative to classroom, which has more limited and traditional connotationsóa room with rows of desks and a chalkboard, for example.
The term also encompasses the culture of a school or classóits presiding ethos and characteristics, including how individuals interact with and treat one anotheróas well as the ways in which teachers may organize an educational setting to facilitate learningóe.g., by conducting classes in relevant natural ecosystems, grouping desks in specific ways, decorating the walls with learning materials, or utilizing audio, visual, and digital technologies. And because the qualities and characteristics of a learning environment are determined by a wide variety of factors, school policies, governance structures, and other features may also be considered elements of a ìlearning environment.î
Educators may also argue that learning environments have both a direct and indirect influence on student learning, including their engagement in what is being taught, their motivation to learn, and their sense of well-being, belonging, and personal safety. For example, learning environments filled with sunlight and stimulating educational materials would likely be considered more conducive to learning than drab spaces without windows or decoration, as would schools with fewer incidences of misbehavior, disorder, bullying, and illegal activity. How adults interact with students and how students interact with one another may also be considered aspects of a learning environment, and phrases such as ìpositive learning environmentî or ìnegative learning environmentî are commonly used in reference to the social and emotional dimensions of a school or class.
...
\section{Fuzzy Logic}
	...
	Zadeh introduced the term fuzzy logic in his work ìfuzzy setsî, where he described the mathematics of the fuzzy set theory in 1965.
...
\subsection{Fuzzy sets}
	...
	Fuzzy sets are an extension of the classic set theory and, as it name implies it, it is a set with boundaries not well defined, this means that the transition of belonging or not belonging to certain set is gradual, and this smooth transition is characterized by grades of membership that gives the fuzzy sets flexibility in modeling linguistic expressions commonly used, such as ìthe weather is coldî or ìGustavo is tallî.
 
Figure 2.1.Key-Value example.

\subsection{Fuzzy logic controller}

	Fuzzy control is a control method based on fuzzy logic. Just as fuzzy logic can be described simply as ìcomputing with words rather than numbersî fuzzy control can be described simply as ìcontrol with sentences rather than equationsî.
	The collection of rules is called a rule base. The rules are in the familiar if-then format, and formally the ìifî side is called the antecedent and the ìthenî side is called the consequent.
...
\item read(p) (rd)
\begin{itemize}
\item versi√≥n del ‚Äútake‚Äù en que la tupla que le es asignada no se elimina del
espacio de tuplas
...
\end{figure}
\section{Kinect 2}
https://hipertextual.com/2013/10/kinect-xbox-one-funcionamiento
link
Investigadores de Microsoft Research nos muestran cÛmo la nueva versiÛn de Kinect, el sensor de movimiento de Microsoft, supera en todo a su antecesor, y lo convierte en un dispositivo con muchÌsimas oportunidades para la investigaciÛn en diferentes ramas.
øCÛmo funciona Kinect de Xbox One?
En el aÒo 2010 Microsoft presentÛ un nuevo dispositivo que servirÌa como complemento o accesorio de su consola de videojuegos de sobremesa, Xbox 360. Este dispositivo que lleva el nombre de Kinect cambiÛ muchas cosas, y no solamente en el mundo de los videojuegos. Para los gamers, por primera vez podrÌan controlar sus juegos en casa sencillamente con su cuerpo, o incluso con comandos de voz; pero la ciencia aprovechÛ este pequeÒo aparato para mucho m·s.

Sin embargo, la segunda versiÛn de Kinect promete dejar en el pasado a su antecesor, super·ndolo en todo aspecto, e incorporando nuevas tecnologÌas que sÌ, Microsoft en teorÌa sigue dirigiendo a los videojuegos, pero tambiÈn puede ser aprovechada en muchos otros aspectos, desde la investigaciÛn cientÌfica y mÈdica, hasta la espacial, o en la ediciÛn y creaciÛn de animaciones. Las posibilidades son muy amplias.

Microsoft Research, los laboratorios m·s curiosos del gigante de Redmond, por asÌ decirlo, han querido explicar a travÈs de dos vÌdeos cÛmo funciona el nuevo Kinect de Xbox One y quÈ es lo que hace especial sus nuevas caracterÌsticas tÈcnicas.



En el caso de su sensor o su ojo, como lo llaman en Microsoft Research, cuenta con nuevas capacidades que incluyen no solo una c·mara de mayor nitidez, ideal para ser utilizada en vÌdeoconferencias a travÈs de Skype, por ejemplo; sino tambiÈn cuenta con nuevas tecnologÌas que permite captar al usuario con mayor profundidad, a diferencia de la versiÛn anterior, y en tres dimensiones. La sensibilidad del captador detalla a tal punto de percatarse si la persona abre su boca, o sonrÌe.

Adem·s, cuenta con tecnologÌa infrarroja para poder ver incluso con en completa oscuridad, sin ser afectado por luces de l·mparas o mÛviles. Esto es peculiarmente ˙til para los usuarios de Xbox One que juegan o ven pelÌculas con la luz apagada, ya que podr·n seguir dando Ûrdenes a la consola usando gestos con las manos, sin ning˙n problema.



Pero la gran maravilla del nuevo Kinect se encuentra en la tecnologÌa que han incorporado en su "cerebro". Su capacidad de captaciÛn va mucho m·s all· que simplemente ver y analizar nuestros gestos, y esto ofrece oportunidades increÌbles m·s all· de simplemente jugar.

Kinect de Xbox One puede medir el ritmo cardÌacoEl nuevo Kinect cuenta con sensores que permiten detectar no solo nuestros movimientos, sino tambiÈn la posiciÛn de nuestros cuerpos, en quÈ sentido giramos nuestras manos, o si movemos nuestros pulgares. Adem·s, puede captar y analizar la fuerza que ejercen nuestros m˙sculos, y ese es quiz·s el mayor avance en este sentido que ofrece Microsoft con su nuevo dispositivo. Finalmente el nuevo Kinect puede medir el ritmo cardÌaco de su usuario simplemente usando su c·mara.

Con la primera versiÛn de Kinect, investigadores mÈdicos para algunos estudios, e investigadores de la NASA se plantearon la posibilidad de medir el peso de los astronautas en el espacio usando Kinect. Si todo eso era posible con la primera versiÛn, el nuevo Kinect de Xbox One ofrecer· muchÌsimas m·s posibilidades a la ciencia y la medicina; y ni hablar de lo que podr·n hacer animadores con este aparato.
